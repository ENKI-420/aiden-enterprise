...
import { Bot, Database, Shield, Users, Video } from 'lucide-react';
  ...
  return (
    <>
      <div className='flex min-h-screen flex-col'>
        ...
        <section
          id='hero'
          className='relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-b from-black via-transparent to-transparent'
        >
          <CssGridBackground />
          <FramerSpotlight />
          <div className='container px-4 md:px-6 py-16 md:py-20'>
            <div className='flex flex-col items-center text-center max-w-3xl mx-auto'>
              ...
              <p className='text-xl text-muted-foreground md:text-2xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed max-w-2xl mb-12'>
                Real-time WebRTC conferencing + AI copilots tailored by role. Secure,
                HIPAA-compliant. Embedded intelligence across video, text, and documents.
              </p>
            ...
            <div className='grid gap-6 lg:grid-cols-3 lg:gap-12 items-start'>
              <div className='flex flex-col items-center space-y-4 text-center'>
                ...
                <p className='text-muted-foreground'>
                  WebRTC-based HIPAA video rooms with AI copilots, role-based prompts, and file drop
                  zones.
                </p>
              </div>
              <div className='flex flex-col items-center space-y-4 text-center'>
                ...
                <p className='text-muted-foreground'>
                  Mix GPT, Claude, BioGPT and others to summarize, translate, or extract from
                  documents, video, or speech.
                </p>
              </div>
              <div className='flex flex-col items-center space-y-4 text-center'>
                <div className='flex h-16 w-16 items-center justify-center rounded-full bg-primary text-primary-foreground'>
              ...
              <div className='flex flex-col justify-center space-y-4'>
                <div className='space-y-2'>
                  ...
                  <p className='text-muted-foreground md:text-xl'>
                    Custom enterprise and federal pricing available. Monthly tiers from $499–$9,999
                    with BAA & SLA included.
                  </p>
                </div>
                <div className='space-y-4'>
                  <div className='flex items-center gap-2'>
                    ...
                    <span>
                      Unlimited user roles (Clinician, Developer, Legal, Investor, Patient)
                    </span>
                  </div>
                  <div className='flex items-center gap-2'>
